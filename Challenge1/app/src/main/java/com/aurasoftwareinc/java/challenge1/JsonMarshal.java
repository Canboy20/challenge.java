        ...
        try
        {
            ...
            for (Field field : myObjectClass.getDeclaredFields()) {
                ...
                if (!field.getName().equals("serialVersionUID") &&  !field.isSynthetic()) {
                    ...
                    //If the current field is a primitive, then we can directly set the value of the JSON without any further checks(We still have to check if variable is null or not)
                    if(field.getType().isPrimitive()){
                        ...
                        //IMPORTANT!!!  We first check whether current field is an instance of JsonMarshallInterface(Whether field class implements JsonMarshallInterface contract)
                        ...
                        if(JsonMarshalInterface.class.isAssignableFrom(reference)){
                            ...
                            //marshalJSONMethod.invoke(field.get(object));
